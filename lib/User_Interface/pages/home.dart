  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: widget.user==null? Container(): 
        Text("Welcome ${widget.user.name}"),//dh ally btktbo 3lshan tzhr l name 
      ),
      body: Column(
        children: [
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                MyCourses(courses: widget.user.courses),//da ally btktbo 3lshan tzhr l list
          ...
          Container(width: double.infinity,
              ...
              child: RecentsAlerts(list: this.widget.user.list ,)),
        ],
      ),
    );
  }
